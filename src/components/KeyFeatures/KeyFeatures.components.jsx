      ...
      <div className="kf-heading-container">
        <h2 className="kf-heading-text">Key Features</h2>
			...
			<div className='kf-card-item'>
				...
				/>
				<h2 className='kf-card-title'>
					Custom Habit Tracking
				</h2>
				<p className='kf-card-subtext'>
					Set personal goals, track habits, and
			...
			<div className='kf-card-item'>
				...
				<p className='kf-card-subtext'>
					Get smart recommendations based on your
					habit patterns.
				</p>
			</div>
			...
			<div className='kf-card-item'>
				...
				<p className='kf-card-subtext'>
					Join groups and stay accountable with
					friends.
				</p>
			</div>
			...
			<div className='kf-card-item'>
				...
				<p className='kf-card-subtext'>
					Never miss a day with our intelligent
					notification system.
				</p>
			</div>
		</div>
